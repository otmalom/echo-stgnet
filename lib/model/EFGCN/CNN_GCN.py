...
from lib.model.EFGCN.encoders import image_encoder
...
class FCPredictor(nn.Module):
    def __init__(self, in_channels, num_points):
        ...
        self.fc1 = nn.Linear(7*7*in_channels, 256)
...
class CNN_GCN(nn.Module):
    def __init__(self, kpt_channels, gcn_channels, num_kpts=8, is_gpu=True):
        ...
        # self.kpts_decoder = FCPredictor(self.img_feature_size, num_kpts)
        self.kpts_decoder = kpts_decoder(features_size=self.img_feature_size,
