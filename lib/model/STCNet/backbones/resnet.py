...
def ResNet50(is_color, pretrained_path=None, receptive_keep=False):
    logger.debug("build ResNet50 ......")
    return ResNet(block=Bottleneck, layers=[3, 4, 6, 3], num_feats=[256, 512, 1024, 2048], is_color=is_color)


def ResNet101(is_color, pretrained_path=None, receptive_keep=False):
    logger.debug("build ResNet101 ......")
    return ResNet(block=Bottleneck, layers=[3, 4, 23, 3], num_feats=[256, 512, 1024, 2048], is_color=is_color)
